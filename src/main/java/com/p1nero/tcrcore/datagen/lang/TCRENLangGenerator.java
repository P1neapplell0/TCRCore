...
public class TCRENLangGenerator extends TCRLangProvider {
    ...
    protected void addTranslations() {
        ...
        this.addItemUsageInfo(TCRItems.BOSS_RUSH_MANAGER.get(), "Can only be used in Infinite Samsara. After use, it summons 8 bosses one by one in a random order. If you died you need to restart the challenge! The item will not be consumed.");
        ...
        this.add(TCRItems.PROOF_OF_BOSS_RUSH.get(), "Badge of Boss Rush");
        this.addItemUsageInfo(TCRItems.PROOF_OF_BOSS_RUSH.get(), "YOU ARE ...INVINCIBLE!");
        ...
        this.addInfo("can_only_equip_one", "Only one badge can be equipped!");
        this.addInfo("time_used", "Time Used: [%s]");
        this.addInfo("difficulty", "Difficulty: [%s]");
        ...
        this.addInfo("use_command_to_modify_limit2", "to use \"%s\" to modify the game rules.");
        ...
        this.addInfo("mimic_defense", "%s's current defense: %s%%. Let %s learn more animations to lower its defense!");
