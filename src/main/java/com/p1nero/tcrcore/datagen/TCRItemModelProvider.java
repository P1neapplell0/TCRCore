...
public class TCRItemModelProvider extends ItemModelProvider {
    public TCRItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, TCRCoreMod.MOD_ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        simpleItem(TCRItems.PROOF_OF_ADVENTURE_PLUS);
        simpleItem(TCRItems.PROOF_OF_BOSS_RUSH);
...
//        withExistingItemTexture(TCRItems.NECROMANCY_SCROLL, ItemRegistry.MAGIC_CLOTH);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = TCRCoreMod.MOD_ID; // Change this to your mod x
    ...
    private ItemModelBuilder saplingItem(RegistryObject<Block> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                ResourceLocation.fromNamespaceAndPath(TCRCoreMod.MOD_ID,"block/" + item.getId().getPath()));
    }
    ...
    public void evenSimplerBlockItem(RegistryObject<Block> block) {
        this.withExistingParent(TCRCoreMod.MOD_ID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
    ...
    public void fenceItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/fence_inventory"))
                .texture("texture",  ResourceLocation.fromNamespaceAndPath(TCRCoreMod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
    ...
    public void wallItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/wall_inventory"))
                .texture("wall",  ResourceLocation.fromNamespaceAndPath(TCRCoreMod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
