...
public class TCREffects {
    ...
    public static final RegistryObject<MobEffect> SOUL_INCINERATOR = REGISTRY.register("soul_incinerator", () -> new SimpleEffect(MobEffectCategory.BENEFICIAL, 16262179));
}
